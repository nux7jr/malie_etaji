  ...
  public function __construct()
  {
    self::$card_elements =
      [
        ...
        'text' => __('Строим современные дома для жизни на природе. Мы разработали уникальные и продуманные проектные решения домов. Собственное производство строительных материалов, строительство домов «под ключ» по самой энергоэффективной технологии. Гарантия на строительные работы 5 лет.'),
        'links_list' =>
        [
