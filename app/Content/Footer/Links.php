    ...
    public function __construct(){
        self::$links = [
            [
                ...
                (new Link(null,link:'/projects#constructor',text:__('Конструктор дома')))->toArray(),
...
//                (new Link(null,link:'',text:__('Документы проектов')))->toArray(),
            ...
            [
                ...
                (new Link(null,link:'mortgage#mortgage-calc',text:__('Калькулятор ипотеки')))->toArray(),
...
//                (new Link(null,link:'/mortgage/capital#mortgage-programs',text:__('Ипотека  под мат.капитал')))->toArray(),
                ...
                (new Link(null,link:'/mortgage/village#mortgage-programs',text:__('Семейная')))->toArray(),
...
//                (new Link(null,link:'',text:__('Банки-партнеры')))->toArray(),
                (new Link(null,link:'/mortgage#mortgage-adv',text:__('Страхование')))->toArray(),
                (new Link(null,link:'/mortgage#mortgage-faq',text:__('Вопросы и ответы')))->toArray(),
            ],
            [
                (new Link(header:true,link:'/about',text:__('О компании')))->toArray(),
                (new Link(null,link:'/about#all-services',text:__('Услуги компании')))->toArray(),
...
//                (new Link(null,link:'/live',text:__('Live-трансляция')))->toArray(),
                (new Link(null,link:'/about/technologies#certificates',text:__('Сертификаты')))->toArray(),
